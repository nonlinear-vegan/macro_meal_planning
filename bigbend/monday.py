...
if __name__ == '__main__':
	...
	breakfast = ut.calc_macros(['rolled_oats','flake_coconut_half','now_pea_protein_half'],'BREAKFAST',f)
	ut.print_totals(breakfast,False,f,'BREAKFAST')
	## MORNING SNACK
	print(colored("Morning Snack:","blue"))
	morning_snack = ut.calc_macros(['performance_protein','cinnamon_chickpea'],'MORNING SNACK',f)
	ut.print_totals(morning_snack,False,f,'MORNING SNACK')
	## LUNCH
	print(colored("Lunch:","blue"))
	lunch = ut.calc_macros(['almonds','cranberries','performance_protein'],'LUNCH',f)
	ut.print_totals(lunch,False,f,'LUNCH')
	## AFTERNOON SNACK (near workout time)
	print(colored("Afternoon snack:","blue"))
	afternoon_snack = ut.calc_macros(['flake_coconut','cranberries'],'AFTERNOON SNACK',f)
	ut.print_totals(afternoon_snack,False,f,'AFTERNOON SNACK')
	## DINNER
	print(colored("Dinner:","blue"))
	dinner = ut.calc_macros(['minute_rice','now_pea_protein','performance_protein'],'DINNER',f)
