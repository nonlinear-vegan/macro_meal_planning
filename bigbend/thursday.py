...
if __name__ == '__main__':
	...
	f.write("Day 1 of backpack\n")
	## BREAKFAST
	print(colored("Breakfast:",'blue'))
	breakfast = ut.calc_macros(['rolled_oats','fd_strawberries'],'BREAKFAST',f)
	...
	dinner = ut.calc_macros(['minute_rice','now_pea_protein','performance_protein','bkack_bean_soup','flake_coconut_half'],'DINNER',f)
